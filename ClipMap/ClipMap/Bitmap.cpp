...
Bitmap::Bitmap(int x, int y, int b, unsigned char* buffer)
{
    width = height = 0;
    data = NULL;
    set(x, y, b, buffer);
...
//#################################################################//
void Bitmap::save_float(const char* filename)
{
    FILE* fn;
...
//#################################################################//
void Bitmap::load_float(const char* filename)
{
    FILE* fn;
...
//#################################################################//
void Bitmap::set_pixel(int x, int y, int r, int g, int b)
{
...
//#################################################################//
vec3 Bitmap::get_pixel3f(int x, int y)
{
...
void Bitmap::set(int x, int y, int b, unsigned char* buffer)
{
    width = x;
    height = y;
    bpp = b;
